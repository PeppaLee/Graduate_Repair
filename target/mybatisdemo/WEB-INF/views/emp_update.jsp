			...
			<div class="body-content">
				<form onsubmit="return confirm('确定更新吗？')" action="/empupdate.do" method="get" class="form-x" >
					<div class="form-group">
						...
						<div class="field">
							<span style="font-size: x-large">${emp.empno}</span>	<input type="hidden" name="empno" value="${emp.empno}" class="input w50" autofocus/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="date" name="hiredate" value="<fmt:formatDate value='${emp.hiredate }' type="date" pattern='yyyy-MM-dd'/>" class="input w50" />
						</div>
					</div>
